  ...
  output$dt_samples_comparison <- DT::renderDataTable({
    ...
    DT::datatable(myDf,
                  ...
                  callback = htmlwidgets::JS(paste0('
                    ...
                    var base_link1 = \'<p><a href="http://', pavian_options$flask_host, ':', pavian_options$flask_port, pavian_options$domain_suffix, '/download_pavian_data?taxid=\' + taxid_string + \'&amp;sample=\' + pavian_file + \'&amp;action=\'
